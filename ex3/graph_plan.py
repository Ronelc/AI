...
def independent_pair(a1, a2):
    ...
    a =any(i in a2_delete for i in a1_add)
    b = any(i in a1_delete for i in a2_add)

    #interfere effects
    c = any(i in a2_delete for i in a1_pre)
    d = any(i in a1_delete for i in a2_pre)

    #if one of them is true then alls is true
    alls = a or b or c or d
    #if alls is false then retrun true
    return not (alls)
...
# s = any(i in a for i in b)
# s1 = all(i in b for i in a)
# print(s,s1)
